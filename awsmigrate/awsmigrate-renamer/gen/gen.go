...
func (p *pkg) buildRenames() {
	pkgName := "github.com/weAutomateEverything/aws-sdk-go/service/" + p.oldAPI.PackageName()
	if exportMap[pkgName] == nil {
		exportMap[pkgName] = &packageRenames{map[string]string{}, map[string]string{}, map[string]string{}}
	}
	ifacename := "github.com/weAutomateEverything/aws-sdk-go/service/" + p.oldAPI.PackageName() + "/" +
