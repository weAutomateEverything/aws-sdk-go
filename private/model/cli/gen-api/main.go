...
import (
	...
	"github.com/weAutomateEverything/aws-sdk-go/private/model/api"
...
func main() {
	...
	flag.StringVar(&svcImportPath, "svc-import-path", "github.com/weAutomateEverything/aws-sdk-go/service", "namespace to generate service client Go code import path under")
	flag.Parse()
	api.Bootstrap()
